...
from backend.repo.user_repo import save_user, validate_user, parse_user, get_user
...
@app.get("/sessions")
async def get_sessions_api(user: UserModel = Depends(current_user), db: Session = Depends(get_session)):
